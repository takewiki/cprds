                                     ...
                                     tagList(
                                       fluidRow(
                                         column(4,     box(
                                           ...
                                           tags$a(href='参数化BOM模板.xlsx','第一次使用,请下载参数化BOM模板'),
                                           mdl_file('bq_file','请选择需要上传的参数化BOM文件'),
                                           actionButton('bq_sheet_preview',"预览所有页签"),
                                           
                                           mdl_text('bq_sheet_select','请选择指定页签,使用逗号,分隔如PBOM001,PBOM002,PBOM003,不选表示全部')
                                           
                                           ,
                                           actionBttn('bq_toGtab','跳转到G番表')
                                           #,
